...
declare class NSArray<ObjectType> extends NSObject implements CKRecordValue, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding {
	...
	readonly awsmtl_firstObject: any;
	...
	awsmtl_arrayByRemovingFirstObject(): NSArray<any>;

	awsmtl_arrayByRemovingLastObject(): NSArray<any>;

	awsmtl_arrayByRemovingObject(object: any): NSArray<any>;
...
declare class NSConstantString extends NSSimpleCString {
	...
	static aws_stringWithHTTPMethod(HTTPMethod: AWSHTTPMethod): NSConstantString; // inherited from NSString
...
declare class NSData extends NSObject implements CKRecordValue, NSCopying, NSMutableCopying, NSSecureCoding {
	...
	awsgzip_gunzippedData(): NSData;

	awsgzip_gzippedData(): NSData;

	awsgzip_gzippedDataWithCompressionLevel(level: number): NSData;
...
declare class NSDate extends NSObject implements CKRecordValue, NSCopying, NSSecureCoding {
	...
	static aws_clockSkewFixedDate(): Date;

	static aws_dateFromString(string: string): Date;

	static aws_dateFromStringFormat(string: string, dateFormat: string): Date;

	static aws_getRuntimeClockSkew(): number;

	static aws_setRuntimeClockSkew(clockskew: number): void;
	...
	aws_stringValue(dateFormat: string): string;
...
declare class NSDictionary<KeyType, ObjectType> extends NSObject implements NSCopying, NSFastEnumeration, NSFastEnumeration, NSFetchRequestResult, NSMutableCopying, NSSecureCoding {
	...
	aws_objectForCaseInsensitiveKey(aKey: any): any;

	aws_removeNullValues(): NSDictionary<any, any>;

	awsmtl_dictionaryByAddingEntriesFromDictionary(dictionary: NSDictionary<any, any>): NSDictionary<any, any>;

	awsmtl_dictionaryByRemovingEntriesWithKeys(keys: NSSet<any>): NSDictionary<any, any>;
...
declare class NSError extends NSObject implements NSCopying, NSSecureCoding {
	...
	static awsmtl_modelErrorWithException(exception: NSException): NSError;
...
declare class NSFileManager extends NSObject {
	...
	aws_atomicallyCopyItemAtURLToURLBackupItemNameError(sourceURL: NSURL, destinationURL: NSURL, backupItemName: string): boolean;
...
declare class NSJSONSerialization extends NSObject {
	...
	static aws_dataWithJSONObjectOptionsError(obj: any, opt: NSJSONWritingOptions): NSData;
...
declare class NSMutableString extends NSString {
	...
	static aws_stringWithHTTPMethod(HTTPMethod: AWSHTTPMethod): NSMutableString; // inherited from NSString
...
declare class NSNumber extends NSValue implements CKRecordValue, NSFetchRequestResult {
	...
	static aws_numberFromString(string: string): number;
...
declare class NSSimpleCString extends NSString {
	...
	static aws_stringWithHTTPMethod(HTTPMethod: AWSHTTPMethod): NSSimpleCString; // inherited from NSString
...
declare class NSString extends NSObject implements CKRecordValue, CNKeyDescriptor, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding {
	...
	static aws_base64md5FromData(data: NSData): string;

	static aws_stringWithHTTPMethod(HTTPMethod: AWSHTTPMethod): NSString;
	...
	aws_isBase64Data(): boolean;

	aws_isVirtualHostedStyleCompliant(): boolean;

	aws_md5String(): string;

	aws_md5StringLittleEndian(): string;

	aws_regionTypeValue(): AWSRegionType;

	aws_stringWithURLEncoding(): string;

	aws_stringWithURLEncodingPath(): string;

	aws_stringWithURLEncodingPathWithoutPriorDecoding(): string;
...
declare class NSValueTransformer extends NSObject {
	...
	static awsmtl_JSONArrayTransformerWithModelClass(modelClass: typeof NSObject): NSValueTransformer;

	static awsmtl_JSONDictionaryTransformerWithModelClass(modelClass: typeof NSObject): NSValueTransformer;

	static awsmtl_externalRepresentationArrayTransformerWithModelClass(modelClass: typeof NSObject): NSValueTransformer;

	static awsmtl_externalRepresentationTransformerWithModelClass(modelClass: typeof NSObject): NSValueTransformer;

	static awsmtl_valueMappingTransformerWithDictionary(dictionary: NSDictionary<any, any>): NSValueTransformer;

	static awsmtl_valueMappingTransformerWithDictionaryDefaultValueReverseDefaultValue(dictionary: NSDictionary<any, any>, defaultValue: any, reverseDefaultValue: any): NSValueTransformer;
	...
	awsmtl_invertedTransformer(): NSValueTransformer;
