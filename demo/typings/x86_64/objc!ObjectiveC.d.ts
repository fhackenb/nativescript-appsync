...
declare class NSObject implements NSObjectProtocol {
	...
	aws_copyPropertiesFromObject(object: NSObject): void;

	aws_properties(): NSDictionary<any, any>;
	...
	databasePoolDidAddDatabase(pool: AWSFMDatabasePool, database: AWSFMDatabase): void;

	databasePoolShouldAddDatabaseToPool(pool: AWSFMDatabasePool, database: AWSFMDatabase): boolean;
